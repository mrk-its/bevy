use super::{WebGL2RenderContext, WebGL2RenderResourceContext};
...
pub struct WebGL2RenderGraphExecutor {
    pub max_thread_count: usize,
}

impl WebGL2RenderGraphExecutor {
    pub fn execute(
        &self,
        world: &World,
        resources: &Resources,
        ...
        for stage in stages.iter_mut() {
            ...
            for jobs_chunk in stage.jobs.chunks_mut(chunk_size) {
                ...
                // s.spawn(move |_| {
                let mut render_context = WebGL2RenderContext::new(device, render_resource_context);
